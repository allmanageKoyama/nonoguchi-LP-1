        ...
        <div id="main-cts" class="cf">
          ...
          <div class="mv">
              <div class="container">
                <div class="star">
                  <span>
                    <img src="<?php echo home_url() ;?>/src/img/star-left.svg" alt="">
                    <img class="star-item star-00" src="<?php echo home_url() ;?>/src/img/star-00.svg" alt="">
                    <img class="star-item star-01" src="<?php echo home_url() ;?>/src/img/star-01.svg" alt="">
                    <img class="star-item star-02" src="<?php echo home_url() ;?>/src/img/star-02.svg" alt="">
                    <img class="star-item star-03" src="<?php echo home_url() ;?>/src/img/star-03.svg" alt="">
                    <img class="star-item star-04" src="<?php echo home_url() ;?>/src/img/star-04.svg" alt="">
                    <img class="star-item star-05" src="<?php echo home_url() ;?>/src/img/star-05.svg" alt="">
                    <img class="star-item star-06" src="<?php echo home_url() ;?>/src/img/star-06.svg" alt="">
                    <img class="star-item star-07" src="<?php echo home_url() ;?>/src/img/star-07.svg" alt="">
                    <img class="star-item star-08" src="<?php echo home_url() ;?>/src/img/star-08.svg" alt="">
                    <img class="star-item star-09" src="<?php echo home_url() ;?>/src/img/star-09.svg" alt="">
                    <img class="star-item star-10" src="<?php echo home_url() ;?>/src/img/star-10.svg" alt="">
                  </span>
                  <span>
                    <img src="<?php echo home_url() ;?>/src/img/star-right.svg" alt="">
                    <img class="star-item star-11" src="<?php echo home_url() ;?>/src/img/star-11.svg" alt="">
                    <img class="star-item star-12" src="<?php echo home_url() ;?>/src/img/star-12.svg" alt="">
                    <img class="star-item star-13" src="<?php echo home_url() ;?>/src/img/star-13.svg" alt="">
                    <img class="star-item star-14" src="<?php echo home_url() ;?>/src/img/star-14.svg" alt="">
                    <img class="star-item star-15" src="<?php echo home_url() ;?>/src/img/star-15.svg" alt="">
                    <img class="star-item star-16" src="<?php echo home_url() ;?>/src/img/star-16.svg" alt="">
                    <img class="star-item star-17" src="<?php echo home_url() ;?>/src/img/star-17.svg" alt="">
                    <img class="star-item star-18" src="<?php echo home_url() ;?>/src/img/star-18.svg" alt="">
                    <img class="star-item star-19" src="<?php echo home_url() ;?>/src/img/star-19.svg" alt="">
                    <img class="star-item star-20" src="<?php echo home_url() ;?>/src/img/star-20.svg" alt="">
                  </span>
                </div>
